...
///
/// WARNING: In production, store credentials in secure backend, not in app
/// This file contains sensitive Google Cloud credentials for development only
class WalletConfig {
  // Google Cloud Project Configuration
  static const String projectId = 'loyaltycardapp-475919';
  static const String issuerId = '3388000000023018874';
  static const String classId = 'loyalty_card_v1';
  static const String fullClassId = '$issuerId.$classId';

  // Service Account Credentials
  static const String serviceAccountEmail = 'wallet-service@loyaltycardapp-475919.iam.gserviceaccount.com';
  static const String clientId = '117213026543794692236';
  static const String privateKeyId = '85ee5746c31eb5472a4c05af166a3883848fa0e4';
...
-----END PRIVATE KEY-----''';
  ...
  static const String oauthTokenUrl = 'https://oauth2.googleapis.com/token';
  static const String walletApiBaseUrl = 'https://walletobjects.googleapis.com/walletobjects/v1';
  static const String saveToWalletBaseUrl = 'https://pay.google.com/gp/v/save';

  // OAuth Scopes
  static const String walletObjectIssuerScope = 'https://www.googleapis.com/auth/wallet_object.issuer';

  // Card Configuration
  static const String cardBackgroundColor = '#4285f4'; // Google Blue
  static const String logoUrl = 'https://via.placeholder.com/150'; // Placeholder logo

  // Level thresholds for loyalty program
  static const Map<String, int> levelThresholds = {'Bronze': 0, 'Silver': 100, 'Gold': 500, 'Platinum': 1000};
}
